...
struct ModelTests {
    ...
    func providerTypeDefaultModels() {
        #expect(ProviderType.openAI.defaultModel == "gpt-5.6-sol")
        #expect(ProviderType.anthropic.defaultModel == "claude-fable-5")
        #expect(ProviderType.gemini.defaultModel == "gemini-3.6-flash")
        #expect(ProviderType.grok.defaultModel == "grok-4.5")
    ...
    @Test("Anthropic picker includes Claude Sonnet 5")
    func anthropicListsSonnet5() {
