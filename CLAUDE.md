...
**Latest release:** v0.5.3 — refreshed curated model lists. Defaults now reflect 2026-04 reality: GPT-5.5 (was 5.4), Claude Opus 4.7 (was 4.6), Grok 4.20 reasoning-tuned (was 3 — and three of the prior list entries had silently rotted out of xAI's API). Gemini default (3.1 Pro Preview) unchanged; still latest. CFBundleVersion `1777000001`. Builds on v0.5.2's Sparkle build-number scheme lock and v0.5.0's "Configured AI tools" panel + sidebar update-status footer.
