...
- **Voice for long-form content.** Articles, blog posts, marketing copy — load `/Users/chrisdoyle/Library/CloudStorage/Dropbox/Build/Content/voice-of-chris-doyle.md` first.
